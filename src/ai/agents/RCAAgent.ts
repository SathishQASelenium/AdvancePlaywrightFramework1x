...
/** Extended result kept for reporter backward-compatibility (`rca.testTitle`). */
export interface RCAResult extends RcaVerdict {
    testTitle: string;
}
